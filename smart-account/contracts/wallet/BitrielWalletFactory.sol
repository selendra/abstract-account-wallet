 ...
 */
contract BitrielWalletFactory is IBitrielWalletFactory {
    ...
    modifier onlyOwner() {
        require(owner == msg.sender, "BitrielWalletFactory:: only owner");
        _;
    }
    ...
    function createAccount(
        ...
        require(
            ...
            "BitrielWalletFactory:: implementation not set"
        );
    ...
    function getInitializer(
        ...
        return abi.encodeCall(BitrielWallet.initialize, (_owner));
    }

    /**
     * @dev Allows to set a new implementation contract address
     * @param _newImpl new implementation BitrielWalletContract
     */
    function setImplementation(BitrielWallet _newImpl) external onlyOwner {
    ...
    function changeOwner(address _newOwner) external onlyOwner {
        require(
            _newOwner != address(0),
            "BitrielWalletFactory:: new owner cannot be zero address"
        );
        owner = _newOwner;
