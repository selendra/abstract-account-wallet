...
import "../interfaces/IBitrielWallet.sol";
import "../interfaces/IBitrielWalletFactory.sol";
import "../access/AccessController.sol";

contract BitrielWallet is
    BaseAccount,
    UUPSUpgradeable,
    Initializable,
    ...
    IBitrielWallet
{
    ...
    IBitrielWalletFactory private immutable _walletFactory;
    bytes4 private constant ERC1271_SUCCESS = 0x1626ba7e;

    /// EXTERNAL METHODS
    constructor(
        IEntryPoint anEntryPoint,
        IBitrielWalletFactory anWalletFactory
    ) {
        require(
            address(anEntryPoint) != address(0) &&
                address(anWalletFactory) != address(0),
            "BitrielWallet:: invalid constructor parameter"
        );
    ...
    function executeBatch(
        ...
        require(
            ...
            "BitrielWallet:: executeBatch: wrong array lengths"
        );
    ...
    receive() external payable {
        emit BitrielWalletReceived(msg.sender, msg.value);
    }
    ...
    function entryPoint()
        ...
        view
        virtual
        override(BaseAccount, IBitrielWallet)
        returns (IEntryPoint)
    {
        return _entryPoint;
    }
    ...
    function _initialize(address anOwner) internal virtual {
        _addOwner(anOwner);
        emit BitrielWalletInitialized(_entryPoint, anOwner);
    }
    ...
    function _authorizeUpgrade(
        ...
        require(
            ...
            "BitrielWallet:: upgrade implementation invalid"
        );
    }
}
