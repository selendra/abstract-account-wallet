 ...
 */
contract BitrielPaymaster is BasePaymaster, Whitelist, ReentrancyGuard {
    ...
    function withdrawFunds(uint256 _amount) external nonReentrant {
        require(
            ...
            "BitrielPaymaster:: not enough deposited funds"
        );
    ...
    function _validatePaymasterUserOp(
        ...
        // we only "require" it here so that the revert reason on invalid signature will be of "BitrielPaymaster", and not "ECDSA"
        require(
            signature.length == 64 || signature.length == 65,
            "BitrielPaymaster:: invalid signature length in paymasterAndData"
        );
        ...
        require(
            ...
            "BitrielPaymaster:: Sponsor paymaster funds too low"
        );
