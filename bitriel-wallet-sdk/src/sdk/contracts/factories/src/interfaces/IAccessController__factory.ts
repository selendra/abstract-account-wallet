...
import type { IAccessController, IAccessControllerInterface } from '../../../src/interfaces/IAccessController';
...
export class IAccessController__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): IAccessController {
