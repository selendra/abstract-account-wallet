...
import type { BitrielWalletFactory, BitrielWalletFactoryInterface } from '../../../src/wallet/BitrielWalletFactory';
...
const _abi = [
  ...
  },
  {
    inputs: [
      {
        internalType: 'contract BitrielWallet',
        name: '_newImpl',
        type: 'address',
      },
    ],
...
type BitrielWalletFactoryConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (xs: BitrielWalletFactoryConstructorParams): xs is ConstructorParameters<typeof ContractFactory> =>
  xs.length > 1;

export class BitrielWalletFactory__factory extends ContractFactory {
  constructor(...args: BitrielWalletFactoryConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  ): Promise<BitrielWalletFactory> {
    return super.deploy(_owner, overrides || {}) as Promise<BitrielWalletFactory>;
  }
  ...
  override attach(address: string): BitrielWalletFactory {
    return super.attach(address) as BitrielWalletFactory;
  }
  override connect(signer: Signer): BitrielWalletFactory__factory {
    return super.connect(signer) as BitrielWalletFactory__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): BitrielWalletFactoryInterface {
    return new utils.Interface(_abi) as BitrielWalletFactoryInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): BitrielWalletFactory {
    return new Contract(address, _abi, signerOrProvider) as BitrielWalletFactory;
  }
}
