...
export interface IBitrielWalletFactoryInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: 'accountCreationCode' | 'checkImplementation' | 'createAccount' | 'getAddress',
  ): FunctionFragment;

  encodeFunctionData(functionFragment: 'accountCreationCode', values?: undefined): string;
  encodeFunctionData(functionFragment: 'checkImplementation', values: [PromiseOrValue<string>]): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: 'checkImplementation', data: BytesLike): Result;
...
export type AccountCreationEvent = TypedEvent<[string, string, BigNumber], AccountCreationEventObject>;
...
export type ImplementationSetEvent = TypedEvent<[string], ImplementationSetEventObject>;

export type ImplementationSetEventFilter = TypedEventFilter<ImplementationSetEvent>;

export interface IBitrielWalletFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IBitrielWalletFactoryInterface;
