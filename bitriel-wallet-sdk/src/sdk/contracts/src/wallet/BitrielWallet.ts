...
export interface BitrielWalletInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: 'changeProposalTimelock', values: [PromiseOrValue<BigNumberish>]): string;
  ...
  encodeFunctionData(functionFragment: 'guardianCount', values?: undefined): string;
  encodeFunctionData(functionFragment: 'guardianPropose', values: [PromiseOrValue<string>]): string;
  ...
  encodeFunctionData(functionFragment: 'proposalTimelock', values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: 'guardianCount', data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: 'proposalTimelock', data: BytesLike): Result;
  ...
  events: {
    ...
    'BitrielWalletInitialized(address,address)': EventFragment;
    'BitrielWalletReceived(address,uint256)': EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: 'BitrielWalletInitialized'): EventFragment;
  getEvent(nameOrSignatureOrTopic: 'BitrielWalletReceived'): EventFragment;
...
export interface BitrielWalletInitializedEventObject {
  entryPoint: string;
  owner: string;
}
export type BitrielWalletInitializedEvent = TypedEvent<[string, string], BitrielWalletInitializedEventObject>;

export type BitrielWalletInitializedEventFilter = TypedEventFilter<BitrielWalletInitializedEvent>;

export interface BitrielWalletReceivedEventObject {
  from: string;
  amount: BigNumber;
}
export type BitrielWalletReceivedEvent = TypedEvent<[string, BigNumber], BitrielWalletReceivedEventObject>;

export type BitrielWalletReceivedEventFilter = TypedEventFilter<BitrielWalletReceivedEvent>;
...
export type ProposalDiscardedEvent = TypedEvent<[BigNumber, string], ProposalDiscardedEventObject>;

export type ProposalDiscardedEventFilter = TypedEventFilter<ProposalDiscardedEvent>;
...
export type ProposalTimelockChangedEvent = TypedEvent<[BigNumber], ProposalTimelockChangedEventObject>;

export type ProposalTimelockChangedEventFilter = TypedEventFilter<ProposalTimelockChangedEvent>;
...
export type QuorumNotReachedEvent = TypedEvent<[BigNumber, string, BigNumber], QuorumNotReachedEventObject>;

export type QuorumNotReachedEventFilter = TypedEventFilter<QuorumNotReachedEvent>;
...
export interface BitrielWallet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BitrielWalletInterface;
  ...
  filters: {
    ...
    'BitrielWalletInitialized(address,address)'(
      entryPoint?: PromiseOrValue<string> | null,
      owner?: PromiseOrValue<string> | null,
    ): BitrielWalletInitializedEventFilter;
    BitrielWalletInitialized(
      entryPoint?: PromiseOrValue<string> | null,
      owner?: PromiseOrValue<string> | null,
    ): BitrielWalletInitializedEventFilter;

    'BitrielWalletReceived(address,uint256)'(
      from?: PromiseOrValue<string> | null,
      amount?: PromiseOrValue<BigNumberish> | null,
    ): BitrielWalletReceivedEventFilter;
    BitrielWalletReceived(
      from?: PromiseOrValue<string> | null,
      amount?: PromiseOrValue<BigNumberish> | null,
    ): BitrielWalletReceivedEventFilter;
    ...
    'ProposalDiscarded(uint256,address)'(proposalId?: null, discardedBy?: null): ProposalDiscardedEventFilter;
    ProposalDiscarded(proposalId?: null, discardedBy?: null): ProposalDiscardedEventFilter;
    ...
    ProposalSubmitted(proposalId?: null, newOwnerProposed?: null, proposer?: null): ProposalSubmittedEventFilter;

    'ProposalTimelockChanged(uint256)'(newTimelock?: null): ProposalTimelockChangedEventFilter;
    ProposalTimelockChanged(newTimelock?: null): ProposalTimelockChangedEventFilter;
    ...
    QuorumNotReached(proposalId?: null, newOwnerProposed?: null, approvalCount?: null): QuorumNotReachedEventFilter;
