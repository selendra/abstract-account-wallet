...
export interface BitrielWalletFactoryInterface extends utils.Interface {
  functions: {
...
export interface BitrielWalletFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BitrielWalletFactoryInterface;
