export const errorMsg = {
  ...
  '-32502':
    'If using skandha bundler or the default one, please report this issue on https://github.com/selendra/abstract-account-wallet/issues', //transaction rejected because of opcode validation
  ...
  '-32506': 'Please create an issue https://github.com/selendra/abstract-account-wallet/issues', // transaction rejected because wallet specified unsupported signature aggregator
  '-32507': 'Please create an issue https://github.com/selendra/abstract-account-wallet/issues', // transaction rejected because of wallet signature check failed (or paymaster signature, if the paymaster uses its data as signature)
